...
export class EditAdminComponent implements OnInit {
  ...
  client_name: any;
  constructor(private rt: Router, public dialogRef: MatDialogRef<EditAdminComponent>,
  ...
  ngOnInit(): void {
    ...
    this.client_name = this.res_data.client_name
    ...
    this.form.patchValue({
      ...
      // client:this.res_data.client_name,
    });
    // client_name
    this.form.controls['company_name'].setValue(this.res_data.company_id, { onlySelf: true });
    this.form.controls['client'].setValue(this.res_data.client_name);
