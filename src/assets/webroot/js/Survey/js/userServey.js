...
//                                if(i==2 && j==0){
//                                 allans +='<div class="answer-dv" ><div class="answer-no" style="background:'+color[j]+'">'+(j+1)+'</div><div class="answer-txt" style="background:'+color[j]+'"><input name="'+i+'" type="radio"  value='+(j+1)+'">&nbsp; '+data.a[i][j].starting_level_answers.answers+'</div></div>';
//                            }
...
//   
//   
//    $("#col_"+id).css("background-color", "#A80000");
//     $("#col_"+id).addClass('okkk');
//      $("#color_"+id).css("background-color", "#A80000");
//     $("#color_"+id).addClass('okkk');
//     
//    
//    
//    
			 ...
			 queLength = que.length;
                        ...
                        for(var i = 0;i<queLength; i++ ){
                          ...
                          allans = '';
                            ...
                            allans +='<div class="answer-dv" ><div class="answer-no" style="background:'+color[j]+'">'+(j+1)+'</div><label><div class="answer-txt" style="background:'+color[j]+'"><input name="'+i+'" type="radio"  name="'+i+'" value='+(j+1)+' >&nbsp; <div class="answr-rgth-txt">'+data.a[i][j].starting_level_answers.answers+'</div></div></label></div>';

                            }
                            
                          
                          allque += '<li><div class="quiz-no">'+(i+1)+'</div><div class="count_quiz">Question '+(i+1)+' of 15</div><div class="quiz-question"><div class="heading">'+data.q[i]+'</div></div><div class="answers">'+allans+'</div><span id="error_'+i+'" style="display:none;color:red;">Please select any one of the answers.</span></li>';
                           
                        }
                        
                        
                        $("#popup-school").html(allque);
                        $("#popup-school").css('margin-left','0px');
...
//         year +='<option value="'+i+'" >'+i+'</option>';
//         }
//         $("#year").html('<option value="">-Year-</option>'+year);
...
var nextcount_second =0;
 var prevcount_second =0;
// Sunny Added Next option without button clicking

/*
function clickNextFnc() {
	alert('heelo');
...
$(document).on('click', '.answer-txt', function () {
        //  $("#prev2").show();

//        if($('input[name='+nextcount_second+']:checked').length > 0) {
//		alert($('input[name='+nextcount_second+']:checked').val())
//	}
});


//Sunny Selecting Answers without clicking next button end here ---
...
$("#next2").click(function(){
		...
		success: function(data)
		{
            ...
            if(nextcount_second == (queLength-1)){
//		alert('1')
                $("#next2").hide();
//		alert('2')
                $("#save2").show();
...
$.ajax({
		...
		success: function(data)
		{
					...
					setPageProgress('quiz-completed');
