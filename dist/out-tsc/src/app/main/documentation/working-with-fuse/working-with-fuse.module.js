...
let WorkingWithFuseModule = class WorkingWithFuseModule {
};
WorkingWithFuseModule = tslib_1.__decorate([
    NgModule({
        declarations: [
...
export { WorkingWithFuseModule };
//# sourceMappingURL=working-with-fuse.module.js.map