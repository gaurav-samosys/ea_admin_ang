...
import { AccessCodeComponent } from 'app/main/apps/Access-code/access-code/access-code.component';
...
const routes = [
    {
        ...
        resolve: {
            data: AccessService, ExcelService
        }
    }
];
let AccessCodeModule = class AccessCodeModule {
};
AccessCodeModule = tslib_1.__decorate([
    NgModule({
        declarations: [
            AccessCodeComponent
        ],
        ...
        providers: [
            AccessService, PagerService, ExcelService
        ],
    })
], AccessCodeModule);
export { AccessCodeModule };
