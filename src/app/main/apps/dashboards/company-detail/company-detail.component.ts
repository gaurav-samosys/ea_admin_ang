...
export class CompanyDetailComponent implements OnInit {
  ...
  updateSortingOrderCompany(sort_column, sort_order) {
    ...
    this.ASC = sort_order
    // this.companyService.Post(this.getCompanies, {company_id:this.id,company_name:this.companyname,
    ...
    // state:this.state,column:this.sort_column,dir:this.ASC, offset: this.pageNumber, limit: this.pageSize, token: 'LIVESITE' }).subscribe(res => {
    //   this.response = res
    this.showloader = false
  ...
  Search(value, name) {
    ...
    this.companyService.Post(this.getClients, {
      company_id: this.id, company_name: this.companyname,
      client_name: this.clientname, first_name: this.first_name,
      email: this.email, client_vertical: this.vertical1, portal_name: this.portal, city: this.city,
      start_date: this.sdate, end_date: this.edate, status: this.status, country: this.country1,
