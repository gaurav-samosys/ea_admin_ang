...
@NgModule({
    ...
    // UserDetailComponent,AdduserComponent
      entryComponents: [AddUserDialogComponent,ModalComponent,UserConfirmboxComponent,UserEditComponent,EditdialogComponent]
})
