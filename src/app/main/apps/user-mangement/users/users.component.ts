...
import { UserDetailComponent } from '../../home-dashboard/version3/user-detail/user-detail.component';
...
export class UsersComponent implements OnInit {
  ...
  constructor(
    ...
    public _Activatedroute: ActivatedRoute, private location: Location,
  ...
  ngOnInit() {
    ...
    this.id = window.location.href.split('users')[1]
    console.log(this.id)
    this.clientname = this.id.split('/')[1]
    // var client=this.id.split('/')[1].replace(/ /g, "_");
    this.detail_id = this.id.split('/')[2]
    this.clientId = this.id.split('/')[3]
    console.log(this.id.split('/')[1], this.id.split('/')[2], this.id.split('/')[3])
