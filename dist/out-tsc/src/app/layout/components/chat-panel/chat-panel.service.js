...
let ChatPanelService = class ChatPanelService {
    /**
     * Constructor
     *
    ...
    createNewChat(contactId) {
        return new Promise((resolve, reject) => {
            ...
            this._httpClient.post('api/chat-panel-chats', Object.assign({}, chat))
                .subscribe(() => {
...
ChatPanelService = tslib_1.__decorate([
    Injectable(),
