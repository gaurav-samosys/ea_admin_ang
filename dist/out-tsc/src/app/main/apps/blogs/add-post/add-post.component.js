...
let AddPostComponent = class AddPostComponent {
    constructor(router, fb, rout, addpost_service, toastr) {
        this.router = router;
        this.fb = fb;
        this.rout = rout;
        this.addpost_service = addpost_service;
        this.toastr = toastr;
        ...
        this.name = 0;
        this.message = 1;
        this.message1 = "This field is required";
        this.htmlContentWithoutStyles = '';
        // editBlogAPi addBlogApi
        this.editBlogAPi = myGlobals.editBlogAPi;
        this.addBlogApi = myGlobals.addBlogApi;
        this.updateBlogApi = myGlobals.updateBlogApi;
        this.CategoryArray = [
...
], AddPostComponent.prototype, "ckeditor", void 0);
AddPostComponent = tslib_1.__decorate([
    Component({
        selector: 'app-add-post',
        templateUrl: './add-post.component.html',
        styleUrls: ['./add-post.component.scss']
    }),
    tslib_1.__metadata("design:paramtypes", [Router, FormBuilder, ActivatedRoute, AddPostService, ToastrService])
], AddPostComponent);
