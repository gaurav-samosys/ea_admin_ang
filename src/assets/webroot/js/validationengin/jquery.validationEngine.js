 ...
 (function($) {
			...
			for (var i = 0, field_errors = 0; i < rules.length; i++) {
				...
				switch (rules[i]) {
					...
					case "minSize":
						...
						break;
					case "minSizePassing":
						errorMsg = methods._getErrorMessage(form, field, rules[i], rules, i, options, methods._minSizePassing);
						break;
					case "maxSize":
	...
	_checkDuplicate: function(field, rules, i, options) {
		...
		*/
		...
		_minSizePassing: function(field, rules, i, options) {
			var max = rules[i + 1];
			var len = field.val().length;

			if (len > max) {
				var rule = options.allrules.minSizePassing;
				return rule.alertText + max + rule.alertText2;
			}
		},
		/**
