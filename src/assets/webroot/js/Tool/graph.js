...
// Add more li in month
function append_more_month_row(li_obj){
		
	var lastMonth 	= li_obj.parents('.left_slider_main_div').find('.lastYearName').val();
	var curr_month 	= li_obj.attr('data-month');
	if (lastMonth == curr_month) {
		console.log();
	}
