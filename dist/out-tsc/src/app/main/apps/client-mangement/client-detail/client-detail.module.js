...
import { ClientDetailComponent } from 'app/main/apps/client-mangement/client-detail/client-detail.component';
...
let ClientDetailModule = class ClientDetailModule {
};
ClientDetailModule = tslib_1.__decorate([
    NgModule({
        declarations: [
