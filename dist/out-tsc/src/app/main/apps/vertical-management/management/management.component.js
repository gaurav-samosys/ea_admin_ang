...
let ManagementComponent = class ManagementComponent {
    constructor(toastr, _snackBar, rt, _Activatedroute, http, dialog, pagerService, manage_service) {
        this.toastr = toastr;
        ...
        this.displayedColumns = ['s_no', 'cat_name', 'image', 'totalVideos', 'totalQuizzes', 'totalQuestions', 'course_type', 'status', 'action', 'created'];
        this.getVerticalDataList = myGlobals.getVerticalDataList;
        this.topicActive = myGlobals.topicActive;
        this.pageSize = 10;
        this.currentPage = 0;
        this.totalSize = 0;
        this.startIndex = 1;
...
ManagementComponent = tslib_1.__decorate([
    Component({
    ...
    tslib_1.__metadata("design:paramtypes", [ToastrService,
        ...
        Router,
        ActivatedRoute,
        HttpClient, MatDialog, PagerService, ManagementService])
], ManagementComponent);
