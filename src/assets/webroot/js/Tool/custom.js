...
$(document).ready(function() {
	...
	$('.question-icon').hover(
		function () {
// $(this).show();
$(".question-icon .tooltip").fadeIn(100);
}, 
function () {
//$(this).hide();
$(".question-icon .tooltip").fadeOut(100);
}
);
...
jQuery('.view_debt .view_pop-up').click(function(event) {
	...
	jQuery('body').removeClass('acti_scroll');
	...
	jQuery(".cls-step-content-container").removeAttr('style');
});

// graph slider 2nd step
jQuery('.swiper-slide').click(function(event) {
	jQuery('.swiper-slide').removeClass('active_this');
	jQuery(this).addClass('active_this');
// jQuery(this).closest('.swiper-slide').addClass('active_this');
});
